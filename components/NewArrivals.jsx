  ...
  return (
    <div>
      <section className="text-black body-font">
        <div className="container px-5 py-12 lg:pt-4 lg: pb-2 mx-auto flex flex-col items-center ">
          <div className=" lg:w-3/4 sm:w-full product-title flex flex-col justify-center items-center mb-5 ">
            <h1 className="lg:text-5xl sm: text-3xl font-bold mb-3 font-montserrat">New Arrivals</h1>
                ...
                {data?.map((d) => (
                  <div key={d.prod_id} className="p-4 md:w-1/3 ">
                    <Link href={`product/${d.prod_id}`}>
                      <div className="border shadow-xl hover:shadow-customPink/20 border-customPink rounded-lg overflow-hidden transition-transform duration-200 transform hover:scale-105">
                        <img
