          ...
          <div className="bg-white shadow-lg rounded-md p-4">
            ...
            <ul className="space-y-2">
              <li
                ...
                className={`cursor-pointer text-customPink hover:text-customBlue hover:underline ${activeOption === "/profile-detail" ? "border-l-4 border-black font-bold" : "border-l-4 border-transparent"
                  }`}
              >
                Edit Profile
              </li>
              <li
                ...
                className={`cursor-pointer text-customPink hover:text-customBlue hover:underline ${activeOption === "/order-history" ? "border-l-4 border-black font-bold" : "border-l-4 border-transparent"
                  }`}
              >
                My Orders
              </li>
              <li
                ...
                className={`cursor-pointer text-customPink hover:text-customBlue hover:underline ${activeOption === "/address-book" ? "border-l-4 border-black font-bold" : "border-l-4 border-transparent"
                  }`}
              >
                Address Book
              </li>
              <li
                ...
                className={`cursor-pointer text-customPink hover:text-customBlue hover:underline ${activeOption === "/gift-card" ? "border-l-4 border-black font-bold" : "border-l-4 border-transparent"
                  }`}
              >
                Gift Card
              </li>
